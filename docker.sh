...
sudo docker run --name db -d -e POSTGRES_PASSWORD=password -p 5432:5432 -v db:/var/lib/postgresql/data/pgdata us.gcr.io/gcp101233-lv61301devops/646/postgres_lv646:latest
